...
hi StatusLineNC                    guibg=#D4D0C8 guifg=#6F6D69 gui=italic
...
hi Underlined                      guibg=bg      guifg=fg      gui=none
...
" User
hi User0                           guibg=#D4D0C8 guifg=red     gui=none
hi User1                           guibg=#D4D0C8 guifg=#6F6D69 gui=none

" HTML
hi htmlnone                        guibg=bg      guifg=fg      gui=none
hi htmlItalic                      guibg=bg      guifg=fg      gui=none
hi htmlBold                        guibg=bg      guifg=fg      gui=none
hi htmlUnderline                   guibg=bg      guifg=fg      gui=none
